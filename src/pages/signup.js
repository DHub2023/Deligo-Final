      ...
      <div className="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
        <div className="bg-white px-6 py-8 rounded shadow-md text-black w-full">
          <img
            ...
            path
            alt="Logo"
            classname="mx-auto mb-4 w-0 h-0"
          />
          <h1 className="mb-8 text-3xl top-0 text-center font-bold text-rose-500">SIGN UP</h1>
          <input
            type="text"
          ...
          <button
            type="submit"
            className="w-full text-center py-3 rounded bg-green text-white font-bold bg-rose-500 hover:bg-rose-700 focus:outline-none my-1 "
          >
            Create Account
          </button>
