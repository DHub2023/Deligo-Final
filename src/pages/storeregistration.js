...
const StoreRegistration = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-2xl font-bold mb-4">Store Registration Application</h1>
            ...
            <form onSubmit={handleFormSubmit}>
                ...
                <div className="flex mb-4">
                    <div className="w-1/2 pr-2">
                        <label className="block mb-1">Name(Default)</label>
                        <input
                            type="text"
                    ...
                    <div className="w-1/2 pl-2">
                        <label className="block mb-1">Address(Default)</label>
                        <input
                            type="text"
                            className="w-full border border-gray-300 rounded px-3 py-2"
                            value={lastName}
                ...
                <div className="flex mb-4">
                    <div className="w-1/3 pr-2">
                        <label className="block mb-1">Vat/Tax(%)</label>
                        <input
                            type="email"
                            className="w-full border border-gray-300 rounded px-3 py-2"
                            value={email}
                    ...
                    <div className="w-1/3 px-2">
                        <label className="block mb-1">Approx delivery Time</label>
                        <select
                            className="w-full border border-gray-300 rounded px-3 py-2"
