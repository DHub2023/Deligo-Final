          ...
          <div className="flex flex-wrap xl:mx-auto xl:container">
                ...
                <div className="w-full 2xl:pl-48 xl:pt-1">
                  ...
                  <div className="w-full md:w-10/12 mt-3">
                    ...
                    <div className="mt-4 md:mt-8">
                      <h2 className="text-sm md:text-base text-rose-700 font-semibold">
                        Address
                      </h2>
            ...
            <div className="w-full lg:w-1/2 xl:pt-10 lg:pl-24">
              <div className="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
                <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-wider text-rose-700">
                  Let’s Talk
                </h1>
                <div className="w-full 2xl:w-8/12 mt-3" role="form">
                  ...
                  <div className="mt-4 md:mt-8">
                    ...
                    <input
                      className="mt-3 text-base dark:bg-gray-800 border-2 w-11/12 lg:w-full xl:w-10/12 hover:border-rose-600 focus:border-rose-600 focus:outline-none border-rose-400 py-5 pl-4 text-gray-800 dark:text-white"
                      type="text"
                  ...
                  <div className="mt-4 md:mt-8">
                    ...
                    <textarea
                      className="mt-3 text-base dark:bg-gray-800 border-2 w-11/12 lg:w-full xl:w-10/12 resize-none hover:border-rose-600 focus:border-rose-600 focus:outline-none border-rose-400 xl:h-40 py-5 pl-4 text-gray-800 dark:text-white"
                      type="text"
                  ...
                  <div className="py-5">
                    <button className="py-3 md:py-5 dark:bg-white dark:text-rose-800 px-5 md:px-10 bg-rose-900 text-white hover:opacity-90 ease-in duration-150 text-sm md:text-lg tracking-wider font-semibold focus:border-4 focus:ring-2 focus:ring-offset-2 focus:ring-rose-900">
                      Send
                    </button>
                  </div>
                </div>
