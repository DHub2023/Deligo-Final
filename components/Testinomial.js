...
const Testinomial = () => {
    return (
        <div>
            ...
            <div className="container my-2 mx-auto font-poppins md:px-6 bg-gray-100 dark:bg-blue-50">
                <section className="mb-32 text-center">
                    <h2 className="mb-12 text-3xl font-bold dark:text-black">We satisfied some Customer & Restaurant Owners</h2>
                    <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
                        <div className="mb-12 md:mb-0">
                            <div className="mb-6 flex justify-center">
                                <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(1).jpg" className="w-32 rounded-full shadow-lg dark:sha33dow-black/20" />
                            </div>
                            <h5 className="mb-2 text-lg font-bold">Maria Smantha</h5>
                            <h6 className="mb-4 font-medium text-primary dark:text-blue-50">
                                Nursing Assistant
                            </h6>
                            <p className="mb-4 ">
