                ...
                <div className="mb-6 flex-row md:mb-0 md:flex">
                  ...
                  >
                    ...
                    <label
                      ...
                      className="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-white dark:peer-focus:text-primary"
                    >
                      Enter your email
                    </label>
                  </div>
              ...
              <div className="flex lg:flex-row md:flex-col">
                <button className="bg-rose-800 inline-flex py-3 px-5 rounded-lg items-center hover:bg-rose-950 focus:outline-none w-96 h-12">
                  ...
                  <span className="ml-4 flex items-start flex-col leading-none">
                    <span className=" flex text-xs text-white mb-1">
                      Get It On Google Play
                    </span>
                  </span>
                </button>
                <button className="bg-rose-800 inline-flex py-3 px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 w-96 h-12 hover:bg-rose-950 focus:outline-none">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="w-7 h-7"
